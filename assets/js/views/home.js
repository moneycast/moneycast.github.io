  ...
  container.innerHTML = `
    <div class="max-w-md mx-auto px-4 py-6">
      ...
      <div class="grid grid-cols-1 gap-4 mt-4 animate-fade-in" style="animation-delay: 0.05s">
        <!-- Servicio Remesa -->
        <button id="btn-service-remesa" class="glass-card w-full text-left p-6 rounded-3xl flex items-center justify-between group focus:outline-none">
          <div class="flex items-center gap-4">
            ...
            <div>
              <h2 class="text-lg font-bold text-white tracking-tight">${t('service_remesa_title')}</h2>
        ...
        <!-- Servicio Recarga -->
        <button id="btn-service-recarga" class="glass-card w-full text-left p-6 rounded-3xl flex items-center justify-between group focus:outline-none">
          <div class="flex items-center gap-4">
            <div class="p-3.5 bg-zinc-900 rounded-2xl border border-zinc-800 text-zinc-300 group-hover:text-white group-hover:border-zinc-700 transition-colors">
              <i data-lucide="smartphone" class="w-6 h-6"></i>
            </div>
            <div>
              <h2 class="text-lg font-bold text-white tracking-tight">${t('service_recarga_title')}</h2>
